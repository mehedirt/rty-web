    ...
    <div class="heroNav">
      <b-navbar toggleable="lg" class="navBarStyle" :class="[isNavFixed ? 'fixed': '']">
        ...
        <b-navbar-brand class="mr-0" href="#">
          <div class="text-light h2">SoftLab.NY</div>
          <b-button class="px-2 py-2 d-block d-lg-none" squared>
            <span class="h4">017-1729-5256</span>
          </b-button>
        </b-navbar-brand>
        <span class="d-lg-none" @click="showToggleNavbar">
        ...
        <transition name="slide">
          ...
          >
            <b-navbar-nav class="mx-auto">
              ...
              <!-- <b-nav-item>
                <nuxt-link class="menuItem" to="/">MAKETING</nuxt-link>
              </b-nav-item> -->
              <b-nav-item>
            ...
            <b-navbar-brand href="#">
              <b-button class="px-2 py-2 d-none d-lg-block" squared>
                <span class="h4">017-1729-5256</span>
              </b-button>
            </b-navbar-brand>
          </b-collapse>
